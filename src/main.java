...
import menu.MouseSensor; // Import lớp mousesensor bạn đã tạo
...
/**
 * Lớp chính để chạy trò chơi Arkanoid.
 * (Đổi tên từ 'main' thành 'Ass7Game' theo quy ước Java)
 */
public class main {
    ...
    public static void main(String[] args) {
        ...
        if (levels.isEmpty()) {
            System.out.println("Không tìm thấy level hợp lệ. Tải các level mặc định.");
    ...
    private static List<LevelInformation> createLevelList(String[] args) {
        ...
        for (String arg : args) {
            try {
                ...
                switch (levelNum) {
                    case 1: levels.add(new LevelOne()); break;
                    case 2: levels.add(new LevelTwo()); break;
                    case 3: levels.add(new LevelThree()); break;
                    case 4: levels.add(new LevelFour()); break;
                    default:
                        System.out.println("Bỏ qua level không hợp lệ: " + arg);
                        break;
                }
            } catch (NumberFormatException e) {
                System.out.println("Bỏ qua đối số không hợp lệ: " + arg);
            }
        }
        return levels;
    }
